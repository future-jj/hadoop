...
public interface MRJobConfig {
    ...
    /**
     * A comma-separated list of services that function as ShuffleProvider
     * aux-services
    ...
    public static final String DEFAULT_MAPREDUCE_JVM_SYSTEM_PROPERTIES_TO_LOG = "os.name,os.version,java.home,java.runtime.version,java.vendor,"
            +
            "java.version,java.vm.name,java.class.path,java.io.tmpdir,user.dir,user.name";

    /*
     * Flag to indicate whether JDK17's required add-opens flags should be added to
     * MR AM and
     * map/reduce containers regardless of the user specified java opts.
     */
    public static final String MAPREDUCE_JVM_ADD_OPENS_JAVA_OPT = "mapreduce.jvm.add-opens-as-default";
    ...
    public static final String DEFAULT_TASK_PROFILE_PARAMS = "-agentlib:hprof=cpu=samples,heap=sites,force=n,thread=y,"
            + "verbose=n,file=%s";
     ...
     */
    public static final String MR_CLIENT_TO_AM_IPC_MAX_RETRIES_ON_TIMEOUTS = MR_PREFIX
     ...
     */
    public static final String MR_AM_CONTAINERLAUNCHER_THREAD_COUNT_LIMIT = MR_AM_PREFIX
            + "containerlauncher.thread-count-limit";
     ...
     */
    public static final String MR_AM_CONTAINERLAUNCHER_THREADPOOL_INITIAL_SIZE = MR_AM_PREFIX
     ...
     */
    public static final String MR_AM_IGNORE_BLACKLISTING_BLACKLISTED_NODE_PERECENT = MR_AM_PREFIX
    ...
    public static final String MR_AM_TASK_ESTIMATOR_SMOOTH_LAMBDA_MS = MR_AM_PREFIX
    ...
    public static final String MR_AM_TASK_ESTIMATOR_EXPONENTIAL_RATE_ENABLE = MR_AM_PREFIX
            + "job.task.estimator.exponential.smooth.rate";

    /** The lambda value in the smoothing function of the task estimator. */
    String MR_AM_TASK_ESTIMATOR_SIMPLE_SMOOTH_LAMBDA_MS = MR_AM_PREFIX
     ...
     */
    String MR_AM_TASK_ESTIMATOR_SIMPLE_SMOOTH_STAGNATED_MS = MR_AM_PREFIX
     ...
     * prediction.
     */
    String MR_AM_TASK_ESTIMATOR_SIMPLE_SMOOTH_SKIP_INITIALS = MR_AM_PREFIX
    ...
    String MR_TASK_ENABLE_PING_FOR_LIVELINESS_CHECK = "mapreduce.task.ping-for-liveliness-check.enabled";
    boolean DEFAULT_MR_TASK_ENABLE_PING_FOR_LIVELINESS_CHECK = false;
    ...
    public static final String MR_AM_HISTORY_MAX_UNFLUSHED_COMPLETE_EVENTS = MR_AM_PREFIX
            + "history.max-unflushed-events";
    public static final int DEFAULT_MR_AM_HISTORY_MAX_UNFLUSHED_COMPLETE_EVENTS = 200;

    public static final String MR_AM_HISTORY_JOB_COMPLETE_UNFLUSHED_MULTIPLIER = MR_AM_PREFIX
            + "history.job-complete-unflushed-multiplier";
    public static final int DEFAULT_MR_AM_HISTORY_JOB_COMPLETE_UNFLUSHED_MULTIPLIER = 30;

    public static final String MR_AM_HISTORY_COMPLETE_EVENT_FLUSH_TIMEOUT_MS = MR_AM_PREFIX
            + "history.complete-event-flush-timeout";
    public static final long DEFAULT_MR_AM_HISTORY_COMPLETE_EVENT_FLUSH_TIMEOUT_MS = 30 * 1000l;

    public static final String MR_AM_HISTORY_USE_BATCHED_FLUSH_QUEUE_SIZE_THRESHOLD = MR_AM_PREFIX
            + "history.use-batched-flush.queue-size.threshold";
    ...
    // value
    public static final String DEFAULT_MR_AM_ADMIN_USER_ENV = Shell.WINDOWS ? ""
    ...
    public static final String DEFAULT_MAPRED_ADMIN_JAVA_OPTS = "-Djava.net.preferIPv4Stack=true " +
    ...
    public static final String DEFAULT_MAPRED_ADMIN_USER_ENV = Shell.WINDOWS ? "PATH=%PATH%;%HADOOP_COMMON_HOME%\\bin"
            : "LD_LIBRARY_PATH=" + Apps.crossPlatformify("HADOOP_COMMON_HOME") +
                    "/lib/native";
     ...
     * </p>
     */
    public final String DEFAULT_MAPREDUCE_APPLICATION_CLASSPATH = Shell.WINDOWS
